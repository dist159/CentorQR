					...
					if(registrar == true){
						...
						if(tipo == "03"){
							elemento = udid+","+codigo+","+nombre_sitio+","+nombre_tour+","+nombre_punto+","+fecha_hora+","+nombre_guarda_sesion+","+latitud+
								","+longitud+","+mensaje+","+"abierto"+","+codigo+","+localStorage.getItem("pasos");
						...
						if(tipo == "04"){
							codigo_tmp = localStorage.getItem("id_actual_tmp" );
								...
								latitud+","+longitud+","+mensaje+","+"abierto"+","+codigo_tmp+","+localStorage.getItem("pasos");
								localStorage.setItem("mensaje_temporal", '');///////////////////////////
						}
...
function Escanear_Donglekey(codigo){
	...
	if( Validar_CRC(partes[0] ) == true){
	
		if(partes.length == 3){ //validamos que tenga 3 partes
			if(tipo == "02"){
